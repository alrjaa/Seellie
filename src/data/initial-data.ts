...
export const initialUsers: User[] = [
    { id: 'superadmin-1', handle: '@superadmin', visibleId: 'ADM-1001', name: 'المشرف الرئيسي', email: 'super.admin@test.com', passwordHash: 'superadmin123', role: 'superadmin', status: 'active', avatar: 'https://placehold.co/100x100.png', country: 'المملكة العربية السعودية', region: 'منطقة الرياض', city: 'الرياض', mobile: '0500000001', bankAccountNumber: `SA${Math.floor(1000000000000000000000 + Math.random() * 9000000000000000000000)}`, permissions: { canComment: true, canUseVoice: true, canNominateToPersonality: true, canCreateContent: true }, analysisContent: [], posts: [], media: { photos: [], videos: [] }, personalityPhotos: [], comments: [] },
